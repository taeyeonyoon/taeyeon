...
import kotlinx.android.synthetic.main.activity_main.home_community
import kotlinx.android.synthetic.main.base_main_layout.*
import kotlinx.android.synthetic.main.fragment_home_middle.*
import kotlinx.android.synthetic.main.base_main_layout.*
import kotlinx.android.synthetic.main.fragment_home_middle.home_recipe
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        home_recipe.setOnClickListener {
            var intent = Intent(this, RecipeSearch::class.java)
            startActivity(intent)
